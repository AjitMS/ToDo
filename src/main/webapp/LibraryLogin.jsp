<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
		...
		<body>
			<!-- Main Script  -->
			<div class="container justify-content-center col-6 supercontainer" align="center">
				...
				<div class="row">
					<div class="col-md-6 ">
						...
						<div class="row buttonpadding">
							<div class="col-md-12">
								<button type="submit" class="btn btn-block facebook btn-primary">Log in with Facebook</button>
							</div>
						</div>

						<div class="row buttonpadding">
							<div class="col-md-12">
								<button type="submit" class="btn btn-block btn-primary">Log in with Google</button>
							</div>
						</div>
					</div>
					...
					<div class="container col-md-6 sideborder">
						...
						<div id="loginagain-message" class="row hidden alertpad">
							<div class=" col alert alert-warning alert-dismissible fade show hidden-xs-up" role="alert">
								<button type="button" class="close" data-dismiss="alert" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
						...
						<div id="logout-message" class="row hidden alertpad">
							<div class=" col alert alert-success alert-dismissible fade show hidden-xs-up" role="alert">
								<button type="button" class="close" data-dismiss="alert" aria-label="Close">
									<span aria-hidden="true">&times;</span>
